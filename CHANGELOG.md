...
- Fixed framework two page layout issue where pagination was being clipped
- Adjusted `.art-page-view` height calculation to account for work tab height (60px)
- Fixed bottom padding to ensure proper spacing and pagination visibility

### Optimized

- Optimized page layout system to prevent page scrolling, only table data scrolls
- Updated layout content padding structure for better height management
- Improved framework one and framework two layout consistency
